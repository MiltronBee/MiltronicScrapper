...
class RSSManager:
    ...
    def __init__(self, politeness_config: Dict):
        ...
        self.mexican_feeds = {
            ...
            'reforma': 'https://www.reforma.com/rss/',
            ...
            'presidencia': 'https://www.gob.mx/presidencia/rss',
            'dof': 'https://www.dof.gob.mx/rss.php',
            'conacyt': 'https://www.conacyt.gob.mx/index.php/rss',
            'unam_gaceta': 'https://www.gaceta.unam.mx/feed/',
            'unam_revista': 'https://www.revistadelauniversidad.mx/feed',
            'colmex': 'https://www.colmex.mx/feed.xml',
        }
