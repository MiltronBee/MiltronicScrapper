...
class ConfigManager:
    ...
    def _validate_sources(self):
        ...
        for i, source in enumerate(self.sources):
            ...
            # Must have either sitemap_url, start_urls, or urls
            if 'sitemap_url' not in source and 'start_urls' not in source and 'urls' not in source:
                raise ConfigurationError(
                    f"Source '{source['name']}' must have either 'sitemap_url', 'start_urls', or 'urls'"
                )
